...
This module defines parameters specific to node classification tasks.
"""
...
NODE_CLASSIFICATION_PARAMETERS = {
    ...
    'dataset': {
        'name': 'Dataset',
        'description': 'Select a graph dataset for node classification',
        'type': 'select',
        'default': 'cora',
        'options': [
...
DEFAULT_PARAMETERS = DEFAULT_NODE_CLASSIFICATION_PARAMS
